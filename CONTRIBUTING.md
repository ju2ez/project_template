...
Welcome to `ray_tune_template` contributor's guide.
...
If you experience bugs or general issues with `ray_tune_template`, please have a look
...
You can help improve `ray_tune_template` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`ray_tune_template` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `ray_tune_template`'s files. While this mechanism can
...
```
conda create -n ray_tune_template python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/ray_tune_template.git
   cd ray_tune_template
   ```
...
5. Install [pre-commit]:
   ...
   `ray_tune_template` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/ray_tune_template
[issue tracker]: https://github.com/<USERNAME>/ray_tune_template/issues
